...
if (!TICKER) {
  console.log('Usage: node scripts/manual-kb-sync-ticker.js <TICKER>');
  console.log('Example: node scripts/manual-kb-sync-ticker.js AAPL');
  process.exit(1);
}
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log(`║  Manual KB Sync for ${TICKER.padEnd(44)} ║`);
  console.log('╚════════════════════════════════════════════════════════════╝\n');
