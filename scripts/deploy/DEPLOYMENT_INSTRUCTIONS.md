...
docker buildx build --platform linux/amd64 -t fundlens-backend:latest -f Dockerfile .
docker tag fundlens-backend:latest 588082972864.dkr.ecr.us-east-1.amazonaws.com/fundlens-backend:latest
docker push 588082972864.dkr.ecr.us-east-1.amazonaws.com/fundlens-backend:latest

# Build Python parser (for linux/amd64)
docker buildx build --platform linux/amd64 -t fundlens-python-parser:latest -f python_parser/Dockerfile python_parser/
docker tag fundlens-python-parser:latest 588082972864.dkr.ecr.us-east-1.amazonaws.com/fundlens-python-parser:latest
docker push 588082972864.dkr.ecr.us-east-1.amazonaws.com/fundlens-python-parser:latest
