-- Migration: Add Research Assistant Schema (Simplified for Testing)
-- Description: Tenant-wide research conversations without foreign key constraints
-- Date: 2026-01-26
...
DROP TABLE IF EXISTS research_notebooks CASCADE;
